...
## Binary Search
A searching algorithm that searches for an element in a sorted array by repeatedly dividing the search interval in half. <br />
consider this example: arr = [11, 12, 22, 25, 34, 64, 90] and searching for the target value 34
```js
...
## Linear search
A searching algorithm that searches for an element in an array by iterating one by one in order: <br />
consider this example: array = [11, 12, 22, 25, 34, 64, 90] and searching for the target = 25
```js
[11, 12, 22, 25, 34, 64, 90]
  i
...
[64, 34, 25, 12, 22, 11, 90] // swape 64 and 11
  i                   j

[11, 34, 25, 12, 22, 64, 90] // swap 34 and 12
      i       j

[11, 12, 25, 34, 22, 64, 90] // swap 25 and 22
          i       j

[11, 12, 22, 34, 25, 64, 90] // swap 34 and 25
              i   j

[11, 12, 22, 25, 34, 64, 90] // no swap, no value < 34
                  i       j

[11, 12, 22, 25, 34, 64, 90] // no swap and end the outer loop (len -1), no value < 64
                      i   j

[11, 12, 22, 25, 34, 64, 90] // return sorted arr
...
[64, 64, 25, 12, 22, 11, 90]
  j   i
[34, 64, 25, 12, 22, 11, 90] // insert 34
...
[34, 34, 64, 12, 22, 11, 90]
  j
[25, 34, 64, 12, 22, 11, 90] // insert 25
...
[25, 25, 34, 64, 22, 11, 90]
  j
[12, 25, 34, 64, 22, 11, 90] // insert 12
...
[12, 25, 25, 34, 64, 11, 90]
      j
[12, 22, 25, 34, 64, 11, 90] // insert 22
...
[12, 12, 22, 25, 34, 64, 90]
  j
[11, 12, 22, 25, 34, 64, 90] // insert 11
